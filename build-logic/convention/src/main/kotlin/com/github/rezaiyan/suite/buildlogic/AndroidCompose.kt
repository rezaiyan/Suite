...
internal fun Project.configureAndroidCompose(
    ...
    commonExtension.apply {
        ...
        libraries {
            ...
            implementation("androidx-compose-tooling-preview")
            implementation("androidx-compose-material")
            implementation("androidx-activity-compose")
            implementation("androidx-compose-material-iconsExtended")
            implementation("androidx-compose-constraintLayout")
            implementation("androidx-compose-system-ui-controller")
